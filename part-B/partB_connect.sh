...
$ofctl add-flow s1 \
    nw_src=10.1.1.17,nw_dst=10.4.4.48,dl_src=0A:00:00:02:00:00,actions=mod_dl_src:0A:00:0A:01:00:02,mod_dl_dst:0A:00:04:01:00:01,output=2

$ofctl add-flow s1 \
    nw_src=10.4.4.48,nw_dst=10.1.1.17,dl_src=0A:00:04:01:00:01,actions=mod_dl_src:0A:00:00:01:00:01,mod_dl_dst:0A:00:00:02:00:00,output=1


# OVS rules for Switch 2
$ofctl add-flow s2 \
    nw_src=10.1.1.17,nw_dst=10.4.4.48,dl_src=0A:00:0E:FE:00:02,actions=mod_dl_src:0A:00:01:01:00:01,mod_dl_dst:0A:00:01:02:00:00,output=1

$ofctl add-flow s2 \
    nw_src=10.4.4.48,nw_dst=10.1.1.17,dl_src=0A:00:01:02:00:00,actions=mod_dl_src:0A:00:0A:FE:00:02,mod_dl_dst:0A:00:0E:FE:00:02,output=2
...
# OVS rules for Switch 2
$ofctl add-flow s2 \
    nw_src=10.4.4.48,nw_dst=10.6.6.69,dl_src=0A:00:01:02:00:00,actions=mod_dl_src:0A:00:0C:01:00:03,mod_dl_dst:0A:00:05:01:00:01,output=3

$ofctl add-flow s2 \
    nw_src=10.6.6.69,nw_dst=10.4.4.48,dl_src=0A:00:05:01:00:01,actions=mod_dl_src:0A:00:01:01:00:01,mod_dl_dst:0A:00:01:02:00:00,output=1


# OVS rules for Switch 3
$ofctl add-flow s3 \
    nw_src=10.4.4.48,nw_dst=10.6.6.69,dl_src=0A:00:10:FE:00:02,actions=mod_dl_src:0A:00:02:01:00:01,mod_dl_dst:0A:00:02:02:00:00,output=1

$ofctl add-flow s3 \
    nw_src=10.6.6.69,nw_dst=10.4.4.48,dl_src=0A:00:02:02:00:00,actions=mod_dl_src:0A:00:0B:FE:00:02,mod_dl_dst:0A:00:10:FE:00:02,output=2
