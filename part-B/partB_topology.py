...
class CSLRTopo( Topo ):
        ...
        def __init__( self ):
                ...
                self.addLink(s1, r1, bw=100)  # s1-eth2 <-> r1-eth1
                self.addLink(r1, s2, bw=100)  # r1-eth2 <-> s2-eth2
                self.addLink(s2, r2, bw=100)  # s2-eth3 <-> r2-eth1
                self.addLink(r2, s3, bw=100)  # r2-eth2 <-> s3-eth2
